    ...
    landing: {
      ...
      hero: {
        slides: {
          ...
          slide2: {
            title: 'நம்பிக்கையுடன் NEET-ஐ கைப்பற்றுங்கள்',
            subtitle: 'மருத்துவராகும் பாதை இங்கிருந்து தொடங்குகிறது',
            description: 'ஆங்கிலம் மற்றும் தமிழ் ஆதரவுடன் உயிரியல், வேதியியல், இயற்பியல் முழுமையான தயாரிப்பு',
            cta: 'NEET தயாரியை ஆராயுங்கள்',
          },
          slide3: {
            title: 'JEE-யை மேன்மையுடன் வெல்லுங்கள்',
            subtitle: 'பொறியியல் கனவுகள் இங்கு சாத்தியமாகின்றன',
            description: 'IIT நிபுணர்கள் வடிவமைத்த மேம்பட்ட கணிதம், இயற்பியல், வேதியியல் பாடத்திட்டங்கள்',
            cta: 'JEE தயாரியை தொடங்குங்கள்',
          },
          slide4: {
            title: 'சிறந்தவர்களிடம் கற்று, சிறந்தவராகுங்கள்',
            subtitle: 'வருட அனுபவம் கொண்ட நிபுணர் ஆசிரியர்கள்',
            description: 'நேரலை வகுப்புகள், தனிப்பயன் சந்தேக தீர்வுகள் மற்றும் 24/7 ஆதரவு உங்கள் வெற்றிக்காக',
            cta: 'எங்கள் ஆசிரியர்களை சந்தியுங்கள்',
          },
          slide5: {
            title: 'உங்கள் மருத்துவப் பயணம் காத்திருக்கிறது',
            subtitle: 'மாணவரிலிருந்து மருத்துவரான வரை - ஒவ்வொரு படியிலும் நாங்கள் உங்களுடன்',
            description: 'நுண்ணறிவு தவறுப் புத்தகத்தின் மூலம் முன்னேற்றத்தை கண்காணித்து பலவீனங்களை மேம்படுத்துங்கள்',
      ...
      featuresSection: {
        ...
        subtitle: 'NEET & JEE வெற்றிக்கான அனைத்து அம்சങ്ങളും ஒரே நுண்ணறிவு தளத்தில்',
      },
      features: {
